...
public class KafkaConsumerConfigurations {
    ...
    public ConsumerFactory<String, String> consumerFactory() {
        ...
        //properties.put(ConsumerConfig.CLIENT_ID_CONFIG, this.srcClientId);
	...
	public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, String>> 
		...
		log.info("KafkaListenerContainerFactory: Start"); 

		if (this._debug) { 
			log.info("KafkaListenerContainerFactory: Concurrency: " + this.concurrency);
		}
